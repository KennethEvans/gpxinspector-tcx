...
//	private static final String TEST_FILE = "C:/Users/evans/Documents/GPSLink/FitnessHistoryDetail.tcx";
	 ...
	 */
	public static void save(String creator, TrainingCenterDatabaseT tcx, String fileName) throws JAXBException {
	 ...
	 * @throws JAXBException
	 */
	public static void save(String creator, TrainingCenterDatabaseT tcx, File file) throws JAXBException {
		// Create a new JAXBElement<TrainingCenterDatabaseT> for the marshaller
		QName qName = new QName("http://www.garmin.com/xmlschemas/TrainingCenterDatabase/v2", "tcx");
		JAXBElement<TrainingCenterDatabaseT> root = new JAXBElement<TrainingCenterDatabaseT>(qName,
				TrainingCenterDatabaseT.class, tcx);
		// Create a context
		JAXBContext jc = JAXBContext.newInstance(TRAINING_CENTER_DATABASE_V2_PACKAGE);
		// Create a marshaller
	...
	/**
	 * Print a TrainingCenterDatabaseT object into an OutputStream. Should do the
	 * same as save() except the last line write tot the OutputStream instead of a
	 * File.
	 * 
	 * @param gpx
	 * @param out
	 * @throws JAXBException
	 */
	public static void print(String creator, TrainingCenterDatabaseT tcx, OutputStream out) throws JAXBException {
	 ...
	 * @throws JAXBException
	 */
	public static TrainingCenterDatabaseT parse(String fileName) throws JAXBException {
	...
	public static TrainingCenterDatabaseT parse(File file) throws JAXBException {
				...
				for (ActivityLapT lap : laps) {
					...
					for (TrackT track : tracks) {
						...
						for (TrackpointT trackPoint : trackPoints) {
							...
							System.out.println("      lat=" + lat + " lon=" + lon + " ele=" + ele + " hr=" + hr
									+ " cad=" + cad + " dist=" + dist + " sensorState=" + sensorState);
						}
					}
				}
			}
